...
public class Constants {
    ...
    public static final String PREFS_KEY_NETWORK_CREDENTIALS_PREFIX = "network_credentials_";
    ...
    public static final String PREFS_KEY_USER_INTERFACE_LOCATION_ACTION_BUTTONS_ENABLED = "user_interface_location_action_buttons_enabled";
    ...
    public static final String CHAR_RIGHTWARDS_ARROW = "\u25b6";
    public static final String CHAR_LEFTWARDS_ARROW = "\u25c0";
    public static final String CHAR_CIRCLED_H = "\u24bd";
    public static final String CHAR_WHITE_CIRCLED = "\u25cb";
    public static final String CHAR_LEFT_RIGHT_ARROW = "\u21c4";
    public static final String DESTINATION_DIRECTION_ARROW_PREFIX =
            CHAR_RIGHTWARDS_ARROW + CHAR_WHITE_CIRCLED + CHAR_THIN_SPACE;
    public static final String ORIGIN_DIRECTION_ARROW_PREFIX =
            CHAR_LEFTWARDS_ARROW + CHAR_WHITE_CIRCLED + CHAR_THIN_SPACE;
    public static final String DESTINATION_STATION_ARROW_PREFIX =
            CHAR_RIGHTWARDS_ARROW + CHAR_CIRCLED_H + CHAR_THIN_SPACE;
    public static final String ORIGIN_STATION_ARROW_PREFIX =
            CHAR_LEFTWARDS_ARROW + CHAR_CIRCLED_H + CHAR_THIN_SPACE;
    public static final String DESTINATION_ARROW_PREFIX =
            CHAR_RIGHTWARDS_ARROW + CHAR_THIN_SPACE;
    public static final String ORIGIN_ARROW_PREFIX =
            CHAR_LEFTWARDS_ARROW + CHAR_THIN_SPACE;
